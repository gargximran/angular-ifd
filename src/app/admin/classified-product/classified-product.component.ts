...
@Component({
  selector: 'app-classified-product',
  templateUrl: './classified-product.component.html',
  styleUrls: ['./classified-product.component.css']
})
export class ClassifiedProductComponent implements OnInit {
  ...
  fetchData(): any {
    ...
    this.api.post('/classified_product/get_products/user', form).subscribe(
      (res) => {
